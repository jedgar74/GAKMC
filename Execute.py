...
simulation.setexpGA(5)    
simulation.setfinitest([2020, 11, 30])
simulation.setffintest([2020, 12, 6])
...
simulation.setCompStatCase(["Alimentos y Entregas"], ["Alimentos y Entrega santo domingo" ])
